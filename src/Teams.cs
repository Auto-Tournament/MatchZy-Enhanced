...
namespace AutoTournamentCS2
{
    ...
    public partial class AutoTournamentCS2
    {
        ...
        [ConsoleCommand("at_addplayer", "Adds player to the provided team")]
        ...
        public void OnAddPlayerCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            {
                command.ReplyToCommand("Usage: at_addplayer <steam64> <team> \"<name>\"");
                return; 
            }
            ...
            if (playerTeam == "team1")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, atTeam1.teamPlayers);
            } else if (playerTeam == "team2")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, atTeam2.teamPlayers);
        ...
        [ConsoleCommand("at_removeplayer", "Removes the player from all the teams")]
        ...
        {
            if (atTeam1.teamPlayers != null && atTeam1.teamPlayers[steamId] != null) return false;
            if (atTeam2.teamPlayers != null && atTeam2.teamPlayers[steamId] != null) return false;
        ...
        {
            List<JToken?> teams = [atTeam1.teamPlayers, atTeam2.teamPlayers, matchConfig.Spectators];
